export function Hero() {
    return (
        ...
        //         <a href="#contact" className="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-700">
        //             Contact Me
        //         </a>
        //     </div>
        // </div>
        <div className="pb-16 min-h-[40vh] flex flex-row items-center bg-gradient-radial from-slate-800 from-10% to-slate-900 to-50%">
            <div className="container mx-auto px-4 text-center">
                <h1 className="text-3xl md:text-7xl lg:text-6xl font-bold tracking-tighter leading-tight md:leading-none mb-6 text-center dark:text-white">Algoritmos, números y poesía</h1>
